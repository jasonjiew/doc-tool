...
echo         program components, or files were corrupted after install.
echo.
...
echo.
echo         Next steps:
echo          1. Ask IT to whitelist DocTool.exe (and its install folder)
echo             in the endpoint security/encryption software, or
