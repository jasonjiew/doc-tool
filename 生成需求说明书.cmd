...
python scripts\run_pipeline.py requirement %PIPELINE_ARGS%
...
set "RESULT=1"
:finish
if "%RESULT%"=="0" (echo [SUCCESS] Requirement pipeline completed.) else (echo [FAIL] Requirement pipeline failed.)
